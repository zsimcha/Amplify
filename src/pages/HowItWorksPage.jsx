...
const HowItWorksPage = ({ appData }) => {
  ...
  const timeline = [
    ...
    { num: '02', title: 'Choosing Your Causes',  titleColor: 'text-sky-600',     body: "Pick one Chessed organization, or split your giving across a few. Change it every month, or keep it the same forever. Don't see one you support? Members can request it be added." },
