...
const HowItWorksPage = ({ appData }) => {
  ...
  const timeline = [
    ...
    { num: '02', title: 'Choosing Your Causes',  titleColor: 'text-sky-600',     body: "Pick one Chessed organization, split across a few, or request one we're missing. Change it anytime." },
