    ...
    <div className="min-h-screen bg-white font-sans text-slate-900 selection:bg-indigo-100 scroll-smooth relative" onClick={() => setActiveTooltip(null)}>
      ...
      <header className="hero relative isolate overflow-hidden bg-indigo-950 flex flex-col md:min-h-screen">
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-8 md:pb-12 short:pb-6">
          {/* Liquid-glass on phones: same dark tint as before (bg-slate-950/70,
              matching desktop), but with a brighter border and an inset top
              highlight to catch the light, instead of reading as a flat panel.
