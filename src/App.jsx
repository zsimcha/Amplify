          ...
          <div className="hidden md:block overflow-x-auto">
            <table className="w-full text-left border-separate border-spacing-0 rounded-[3rem] overflow-hidden shadow-2xl border border-slate-200 bg-white">
              ...
              <tbody className="bg-white text-center text-center">
                ...
                <tr>
                  <td className="p-6 font-black border-r border-slate-200 text-slate-700 text-left uppercase text-xs md:text-sm tracking-widest leading-none text-center">Exclusive Perks</td>
                  <td className="p-6 md:p-10 border-r border-slate-200 space-y-3 text-xs font-black text-slate-500 uppercase tracking-tighter leading-relaxed text-center text-center">{tierData.silver.perks.map((p, i) => <p key={i}>{p}</p>)}</td>
                  <td className="p-6 md:p-10 border-r border-slate-200 space-y-3 text-xs font-black text-slate-500 uppercase tracking-tighter leading-relaxed text-center text-center">{tierData.gold.perks.map((p, i) => <p key={i}>{p}</p>)}</td>
                  <td className="p-6 md:p-10 space-y-3 text-xs font-black text-indigo-900 uppercase tracking-tighter leading-relaxed text-center text-center">{tierData.diamond.perks.map((p, i) => <p key={i}>{p}</p>)}</td>
                </tr>
