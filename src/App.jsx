...
if (tier === 'gold') return 'text-[#eab308]'; // Rich digital gold
if (tier === 'diamond') return 'text-[#818cf8]'; // Deeper periwinkle/indigo
return 'text-slate-900';
};

const getTierBgGlow = (tier) => {
if (tier === 'silver') return 'from-slate-100';
if (tier === 'gold') return 'from-[#eab308]';
if (tier === 'diamond') return 'from-[#818cf8]';
...
<div className={`absolute top-0 right-0 w-32 h-32 bg-gradient-to-bl ${getTierBgGlow(tier)} to-transparent opacity-10 -z-0`}></div>
...
{/* How it Works - Mobile Compact List View */}
