...
const TermsContent = () => (
  <>
    ...
    <p className="mb-6">Amplify is a for-profit promotional platform designed to facilitate philanthropic giving through incentivized sweepstakes. When a User makes a voluntary contribution through the Platform, one hundred percent (100%) of the gross contribution is remitted directly to a donor-advised fund ("DAF") administered by Givinga, Inc., a nationally recognized 501(c)(3) public charity. Givinga, Inc. will subsequently deduct expenses and fees related to sweepstakes administration—which includes platform licensing fees, advertising costs, prize fulfillment reserves, and management operations—and grant the net proceeds to a designated charitable beneficiary identified for each monthly promotional period. While contributions are routed to a registered charity, Amplify itself is a for-profit entity, and Users are strongly advised to consult a qualified tax professional regarding the tax deductibility of any contribution.</p>
    ...
    <p className="mb-6">To the maximum extent permitted by applicable law, the Services are provided on an "as-is" and "as-available" basis without warranties of any kind, whether express or implied. Except in cases of gross negligence or willful misconduct, Amplify, Givinga, Inc., the designated beneficiaries, and their respective officers, directors, and agents (the "Released Parties") shall not be liable for any indirect, incidental, special, consequential, or punitive damages arising out of your access to or inability to access the Services. Users residing in California expressly waive California Civil Code Section 1542, which states: "A general release does not extend to claims that the creditor or releasing party does not know or suspect to exist in his or her favor at the time of executing the release and that, if known by him or her, would have materially affected his or her settlement with the debtor or released party."</p>
